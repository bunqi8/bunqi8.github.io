...
old_func = """function arrowToTVBars(arrowResult) {
    const bars = [];
...
js = js.replace("let bars = arrowToTVBars(rangeResult);", "let bars = arrowToTVBars(rangeResult, resolution);")
js = js.replace("latestBars = arrowToTVBars(latestResult);", "latestBars = arrowToTVBars(latestResult, resolution);")
js = js.replace("const allBars = arrowToTVBars(allResult);", "const allBars = arrowToTVBars(allResult, resolution);")
