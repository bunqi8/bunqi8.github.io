                ...
                metainfo: {
                    ...
                    defaults: {
                        styles: {
                            ...
                            plot_cross_up: { plottype: 3, linewidth: 4, color: "#2962FF" }, // Blue Cross (thickness 4 - max allowed)
                            plot_cross_dn: { plottype: 3, linewidth: 4, color: "#E040FB" }  // Magenta Cross (thickness 4 - max allowed)
                        },
                        inputs: {
                            len1: 3,
                            len2: 30,
